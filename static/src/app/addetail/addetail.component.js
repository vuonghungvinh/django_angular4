...
var AdDetailComponent = (function () {
    function AdDetailComponent(_activatedRouter) {
        this._activatedRouter = _activatedRouter;
    }
    AdDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subcription = this._activatedRouter.params.subscribe(function (params) {
            _this.slug = params['slug'];
            console.log(params);
        });
    };
    AdDetailComponent.prototype.ngOnDestroy = function () {
